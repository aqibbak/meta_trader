# RailsAdmin config file. Generated on May 21, 2013 11:54
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Meta Trader', 'Admin']
    ...
    list do
      ...
      field :rights do
        pretty_value do
          out = ""
          comma = false
          bindings[:object].full_rights.each do |right|
            out += ", " if comma
            if right.to_s != ""
              out += right.to_s.capitalize
              comma = true
            end
          end
          out
    ...
    list do
      ...
      field :rights do
        pretty_value do
          out = ""
          comma = false
          bindings[:object].rights.each do |right|
            out += ", " if comma
            if right.to_s != ""
              out += right.to_s.capitalize
              comma = true
